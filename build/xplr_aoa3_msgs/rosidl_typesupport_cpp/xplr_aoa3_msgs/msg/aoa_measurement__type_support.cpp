...
static const _AoaMeasurement_type_support_symbol_names_t _AoaMeasurement_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xplr_aoa3_msgs, msg, AoaMeasurement)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xplr_aoa3_msgs, msg, AoaMeasurement)),
  }
};
...
{
  return &::xplr_aoa3_msgs::msg::rosidl_typesupport_cpp::AoaMeasurement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xplr_aoa3_msgs, msg, AoaMeasurement)() {
  return get_message_type_support_handle<xplr_aoa3_msgs::msg::AoaMeasurement>();
}
